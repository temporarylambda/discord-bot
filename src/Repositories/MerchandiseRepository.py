...
class MerchandiseRepository:
    ...
    def findById(self, id):
        ...
        statement = "SELECT merchandises.*, users.name AS user_name, users.uuid FROM merchandises LEFT JOIN users ON users.id = merchandises.user_id WHERE merchandises.id = %s AND merchandises.deleted_at IS NULL"
        parameters = (id,);
